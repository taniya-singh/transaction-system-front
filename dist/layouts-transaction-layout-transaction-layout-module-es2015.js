...
let AddNewComponent = class AddNewComponent {
    constructor(fb, apiService, toastr, spinner, route) {
        this.fb = fb;
    ...
    add(formData) {
        this.spinner.show();
        this.apiService.postData('/transaction/', formData, this.currentUser['loginToken']).subscribe((response) => {
...
let ListComponent = class ListComponent {
    constructor(fb, apiService, toastr, modalService, spinner) {
        this.fb = fb;
        this.apiService = apiService;
        this.toastr = toastr;
        ...
        this.getTrans = () => {
            ...
            this.apiService.getQuery('/transaction', query).subscribe((response) => {
                if (response.statusCode === 200) {
...
//# sourceMappingURL=layouts-transaction-layout-transaction-layout-module-es2015.js.map